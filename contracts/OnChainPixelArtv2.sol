...
contract OnChainPixelArtv2 {
  ...
  function encodeColorArray(
    ...
    return OnChainPixelArtLibrary.encodeColorArray(colors, pixelCompression, colorCount);
  }
  ...
  function composePalettes(
    ...
    return OnChainPixelArtLibrary.composePalettes(palette1, palette2, colorCount1, colorCount2);
  }
  ...
  function composeLayer(
    ...
    return OnChainPixelArtLibrary.composeLayer(layer, colorOffset, colors, totalPixels);
  }
  ...
  function composeLayers(
    ...
    return OnChainPixelArtLibrary.composeLayers(layer1, layer2, totalPixels);
  }
